...
public class DepartamentoDAO extends conexion.ConexionOracle implements Serializable {
    ...
    public int insertaDepartamento(Departamento departamento) {
        ...
        final String query = "INSERT INTO DEPARTAMENTO (IDDEPARTAMENTO, \n" +
                                            ...
                                            "       NOPERSONALBM_ENLACE, IDESTATUS, CLAVE_SUBUR) "
        ...
        try {
            ...
            rs = super.getPreparedStatement(query, new Object[]{
                ...
                departamento.getNoPersonalBmEnlace(),
                departamento.getClaveSubUr()
            }
            ).executeQuery();
    ...
    public int actualizaDepartamento(Departamento departamento) {
        ...
        final String query = "UPDATE DEPARTAMENTO set NOMDEPTO = ?, \n" +
                            ...
                            "       NOUSUARIOULTIMAMODIF = ?, NOPERSONALBM_ENLACE = ?, CLAVE_SUBUR = ? "+
    ...
    public List<Departamento> traeRegistros(int valor) {
        ...
        query = "select IDDEPARTAMENTO, \n" +
                ...
                "       FECHAULTIMAMODIF, \n" +
                "       NOUSUARIOULTIMAMODIF, \n" +
                "       IDESTATUS, CLAVE_SUBUR from DEPARTAMENTO "
        ...
        try {
            ...
            while (rs.next()) {
                ...
                departamento.setClaveSubUr(rs.getString("CLAVE_SUBUR"));
    ...
    public List<Departamento> traeRegistrosLista(int valor) {
        ...
        query = "select DE.IDDEPARTAMENTO, \n" +
                ...
                "       DE.OBSERVACIONES, \n" +
                "       DE.IDESTATUS, DE.NOBLOQUE, DE.IDNIVELAREA, DE.CLAVE_SUBUR from DEPARTAMENTO DE "
                        +continuacion+" ORDER BY 1";
    ...
    public List<Departamento> traeRegistrosDepartamentoMobiliario(int noUsuario) {
        List<Departamento> listaDepartamento;
        System.out.println("Entro a cargar traeRegistrosDepartamentoMobiliario");
        Departamento departamento = null;
        ResultSet rs = null;
        String query = null;
        query = "select DE.IDDEPARTAMENTO, \n" +
                ...
                "       DE.NOUSUARIOBAJA, \n" +
                "       DE.FECHAULTIMAMODIF, \n" +
                "       DE.NOUSUARIOULTIMAMODIF, \n" +
                "       DE.IDESTATUS, DE.CLAVE_SUBUR from DEPARTAMENTO DE, USUARIOS_DEPARTAMENTO UD "+
                "       WHERE DE.IDDEPARTAMENTO = UD.IDDEPARTAMENTO "+
                "       AND UD.NO_USUARIO = "+noUsuario+" AND DE.IDESTATUS=1 "+
                "     ORDER BY 1";
        ...
        try {
            ...
            System.out.println("traeRegistrosDepartamentoMobiliario.size() = " + listaDepartamento.size());
        } catch (SQLException e) {
            System.out.println("Error en traeRegistrosDepartamentoMobiliario() " + e.getMessage());
            listaDepartamento = null;
        } finally {
            try {
                if (rs != null) {
