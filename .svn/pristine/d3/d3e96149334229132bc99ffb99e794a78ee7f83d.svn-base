...
public class DepartamentoControl implements java.io.Serializable {
   ...
   public void asignaenlaceBusqueda(String valor) {
        if (!valor.isEmpty()) {
            personalEnlace = pdao.traeRegistrosPersonalBusqueda(1,1,valor);
    ...
    public void reporte(){
        String consulta = "SELECT DE.IDDEPARTAMENTO,\n" +
                                "  DE.NOMDEPTO,\n" +
                                "  DE.NOPERSONALBM,\n" +
                                "  DE.DOMICILIO,\n" +
                                "  DE.CLAVECT, DE.IDUR, \n" +
                ...
                tituloReporte = "REPORTE DEPARTAMENTOS",
                nombreReporte = "REPORTE_DEPARTAMENTOS",
                noUsuario = accesoC.getClave();
